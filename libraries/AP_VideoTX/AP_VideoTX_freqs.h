...
enum class Model: uint8_t {
    ...
    TBS_UPD_P3 = 4,  // TBS Unify Pro32 DP reduced to 3 power levels (25/1000/2000 mW)
    TBS_UPD3 = 5,  // TBS Unify Pro32 DP 3W (actual emitting power is 2W); 6 power levels (25, 100, 200, 500, 1000, 2000 mW)
