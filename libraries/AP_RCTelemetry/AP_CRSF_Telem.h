...
#error "Only supported on little-endian architectures"
        ...
        uint8_t band : 5;               // A, B, E, AirWave, Race; see AP_VideoTX::VIDEO_CHANNELS/frequency_map in libraries\AP_VideoTX\AP_VideoTX.cpp
        uint16_t user_frequency;
        uint8_t power : 4;              // 25mW = 0, 200mW = 1, 500mW = 2, 800mW = 3, 1000mW = 4
