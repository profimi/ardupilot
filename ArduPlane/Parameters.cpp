...
const AP_Param::Info Plane::var_info[] = {
    ...
    // @Bitmask: 0: Enable all modes, 1:FBWB, 2:Cruise, 3:Auto, 4:RTL, 5:Avoid_ADSB, 6:Guided, 7:Loiter, 8:Circle, 9:QRTL, 10:QLand, 11:Qloiter, 12:AUTOLAND, 13:FBWC
    // @User: Standard
...
// THROTTLE_ALT_MIN works fine, but AUTOTHROTTLE_ALT_MIN fails Mavlink connection in Mission Planner
    ...
    // @User: Standard
    AP_GROUPINFO("TAKEOFF_UNSAFE", 46, ParametersG2, takeoff_unsafe, TAKEOFF_UNSAFE),
