...
const AP_Param::GroupInfo ModeTakeoff::var_info[] = {
    ...
    // @Description: Control signals release ratio in the Takeoff mode on current altitude. Recommended value: 0.1-0.3. Provides mild takeoff without abrupt maneuvers near the ground
    // @Units: ratio
    // @Range: 0.0 1.0
    // @Increment: 0.01
    // @User: Standard
